...
function edsbootstrap_scripts() {
	wp_enqueue_style( 'edsbootstrap-oswald-fonts', 'https://fonts.googleapis.com/css?family=Oswald:500');
	...
	/* Custom Js*/
	wp_enqueue_script('edsbootstrap-custom', get_template_directory_uri().'/assets/js/custom.js',0,0,true);
